...
namespace Engine {
	...
	public:
		...
		explicit ImageButton(std::string img, std::string imgIn, float x, float y, float w = 0, float h = 0, float anchorX = 0, float anchorY = 0, std::string sound = "");
		/// <summary>
